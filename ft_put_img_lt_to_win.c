...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_put_img_lt_to_win.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bjebedia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/07 20:19:11 by bjebedia          #+#    #+#             */
/*   Updated: 2020/09/07 20:19:12 by bjebedia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	ft_put_img_lt_to_win(t_img_n_tex *win_buf, t_game *g_game, t_img_n_tex *tex_01, int img_x_start, int img_y_start)
{
	static float	tex_y;
	static float	tex_x;
	...
	img_x_end = img_x_start + tex_01->width;
	img_y_end = img_y_start + tex_01->height; //from center!!!
