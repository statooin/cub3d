...
void		ft_init_enemies()
{
	...
	g_enemies[0].ienemy_bottom = 1 - g_enemies[0].ienemy_top;
	...
	g_enemies[1].ienemy_bottom = 1 - g_enemies[1].ienemy_top;
	...
	g_enemies[2].ienemy_bottom = 1 - g_enemies[2].ienemy_top;
