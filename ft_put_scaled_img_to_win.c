...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_put_scaled_img_to_win.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bjebedia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/07 20:21:00 by bjebedia          #+#    #+#             */
/*   Updated: 2020/09/07 20:21:43 by bjebedia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	ft_put_scaled_img_to_win(t_img_n_tex *win_buf, t_game *g_game, t_img_n_tex *tex_01, int img_x_center, int img_y_center)
{
	static float	tex_y;
	static float	tex_x;
