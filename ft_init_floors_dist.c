...
int	ft_init_floors_dist(void)
{
	...
	g_math.fdist_to_all_tiles = malloc(sizeof(float*) * (g_game.iscr_height + g_game.iscr_height05));
	idraw_y = g_game.iscr_height05;
	write(1, "start\n", 6);
	while (idraw_y <= (g_game.iscr_height_m1 + g_game.iscr_height05))
	{
